...
package org.wso2.carbon.identity.authenticator.github.internal;
...
public class GithubAuthenticatorServiceComponent {
    ...
    protected void activate(ComponentContext ctxt) {
        try {
            ...
            log.fatal("Error while activating the Github authenticator ", e);
        }
    }

    protected void deactivate(ComponentContext ctxt) {
        if (log.isDebugEnabled()) {
            log.debug("Github authenticator is deactivated");
        }
    }
}
